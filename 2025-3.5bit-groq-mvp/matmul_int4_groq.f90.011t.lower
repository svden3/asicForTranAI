...
void dequantize_output (integer(kind=4)[0:D.4698] * restrict c, real(kind=4)[0:D.4695] * restrict w_scales, real(kind=4)[0:D.4701] * restrict out, integer(kind=4) & restrict m, integer(kind=4) & restrict n)
{
  ...
  <D.4757>:
  _15 = count.15 <= 0;
  D.4758 = .ANNOTATE (_15, 0, 0);
  if (D.4758 != 0) goto L.3; else goto <D.4759>;
  <D.4759>:
  i.12 = 1;
  count.14 = *m;
  <D.4760>:
  _16 = count.14 <= 0;
  D.4761 = .ANNOTATE (_16, 0, 0);
  if (D.4761 != 0) goto L.2; else goto <D.4762>;
  <D.4762>:
...
void matmul_int4_awq (integer(kind=1)[0:D.4746] * restrict a, integer(kind=1)[0:D.4749] * restrict w_q, real(kind=4)[0:] * restrict w_scales, integer(kind=4)[0:D.4752] * restrict c, integer(kind=4) & restrict m, integer(kind=4) & restrict n, integer(kind=4) & restrict k_dim)
{
  ...
  <D.4763>:
  _15 = count.36 <= 0;
  D.4764 = .ANNOTATE (_15, 0, 0);
  if (D.4764 != 0) goto L.11; else goto <D.4765>;
  <D.4765>:
  i.31 = 1;
  count.35 = *m;
  <D.4766>:
  _16 = count.35 <= 0;
  D.4767 = .ANNOTATE (_16, 0, 0);
  if (D.4767 != 0) goto L.10; else goto <D.4768>;
  <D.4768>:
  ...
  if (_27 != 0) goto L.6; else goto <D.4769>;
  <D.4769>:
  <D.4770>:
  _28 = k_idx + 1;
  k_packed = _28 / 2;
  ...
  qval = packed_byte & 15;
  if (qval > 7) goto <D.4771>; else goto <D.4772>;
  <D.4771>:
  qval = qval + -16;
  goto <D.4773>;
  <D.4772>:
  ...
  (*c)[_53] = _54;
  _55 = *k_dim;
  if (k_idx < _55) goto <D.4774>; else goto <D.4775>;
  <D.4774>:
  D.4739 = packed_byte;
  ...
  qval = _58 & 15;
  if (qval > 7) goto <D.4776>; else goto <D.4777>;
  <D.4776>:
  qval = qval + -16;
  goto <D.4778>;
  <D.4777>:
  ...
  if (countm1t.34 == 0) goto L.6; else goto <D.4780>;
  <D.4780>:
  goto <D.4770>;
  L.6:
  L.4:
